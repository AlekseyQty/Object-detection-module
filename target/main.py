...
watch_cascade = cv2.CascadeClassifier('target_st_19.xml')
...
while 1:
    ...
    watches = watch_cascade.detectMultiScale(gray, 1.5, 2)
...
# opencv_createsamples -img rsz_target.jpg -bg bg.txt -info info/info.lst -pngoutput info -maxxangle 0.5 -maxyangle 0.5 -maxzangle 0.5 -num 600
# opencv_createsamples -info info/info.lst -num 600 -w 20 -h 20 -vec positives.vec
